...
format: 
  clean-revealjs:
    footer: "USNCCM 18 - Novel Methods TTA -- July 2025"
    scrollable: true
execute:
  freeze: true
...
::: {.column width="50%"}
![Fall 2024](./img_tta/seminar1.jpg)
:::

::: {.column width="50%"}
![Spring 2025](./img_tta/seminar2.png)
:::
...
* Past TTA Conferences
  * Meshfree and Novel Finite Elements with Applications, *Berkeley, CA 2022*
  * Meshfree and Particle Methods: Applications and Theory *Santa Fe, NM 2018*
  * Nonlocal Methods in Fracture, *Austin, TX 2018*
  * Isogeometric and Meshfree Methods, *La Jolla, CA 2016*
